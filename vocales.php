            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_vocales.php?id=<?php echo $row['id']?>" class="btn btn-secondary">
                                <i class="fas fa-marker"></i> 
                            </a>
                            <a href="delete_task_vocales.php?id=<?php echo $row['id']?>" class="btn btn-danger">
