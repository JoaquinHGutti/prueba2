...
<body>
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto " href="#vocales">Vocales</a></li>
                    ...
                    <a  class="logo"><img src="assets/img/usuario.png" alt="" class="img-fluid"></a>
    ...
    <main id="main">
        ...
        <!-- ======= Portfolio Section ======= -->
        <section id="vocales" class="vocales">
            <div class="section-title" data-aos="fade-up">
                <h2>Vocales</h2>
