...
if  (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM vocales WHERE id=$id";
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE vocales set titulo = '$titulo', link = '$url' WHERE id=$id";
...
<div class="container p-4">
    <div class="row">
        ...
        <div class="card card-body">
            <form action="edit_vocales.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    <div class="form-group">
                        <input name="titulo" type="text" class="form-control" value="<?php echo $titulo; ?>" placeholder="Update Title">
                    </div>
                    <div class="form-group">
                        <textarea name="url" class="form-control" cols="30" rows="10"><?php echo $url;?></textarea>
                    </div>
